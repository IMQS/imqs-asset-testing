...
IF OBJECT_ID (N'AssetRegisterView2014', N'V') IS NOT NULL DROP View [AssetRegisterView2014];
IF OBJECT_ID (N'AssetRegisterIconMove', N'U') IS NOT NULL DROP TABLE [AssetRegisterIconMove];
IF OBJECT_ID (N'AssetRegisterIconFin2014', N'U') IS NOT NULL DROP TABLE [AssetRegisterIconFin2014];
...
CREATE TABLE [dbo].[AssetRegisterIconFin2014](
	[FAR_ID] [int] IDENTITY(1,1) NOT NULL,
	[ComponentID] [varchar](40) NOT NULL,
	[ClientAssetID] [varchar](40) NULL,
	[AssetMoveableID] [varchar](4) NULL,
...
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD CONSTRAINT [PK_AssetRegisterIconFin2014] PRIMARY KEY CLUSTERED
(
	[ComponentID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 70) ON [PRIMARY];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [Extent];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [Extent_Unit_Rate];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  CONSTRAINT [DF_AssetRegisterIconFin2014_CostCentreCode]  DEFAULT ('Not Specified') FOR [CostCentreCode];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  CONSTRAINT [DF_AssetRegisterIconFin2014_GeneralLedgerCode]  DEFAULT ('Not Specified') FOR [GeneralLedgerCode];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [FairValue];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [CostOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [CarryingValueOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  CONSTRAINT [DF_AssetRegisterIconFin2014_RespDepartmentID]  DEFAULT ('Not Specified') FOR [RespDepartmentID];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [InsuranceCover];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DebtSecurityApplicable];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [AdditionsOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [AdditionsFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ResidualPct];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DepreciationOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DepreciationFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ProvisionOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ProvisionAdjust];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DisposalProceedCost];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DerecognitionCost];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DerecognitionDepr];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [TransferCost];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [TransferDepr];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [FairValueLessCostSell];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ValueInUse];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ImpairmentAll];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ImpairmentFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevImpairmentFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ImpairmentDerecog];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevImpairmentAll];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [CRC];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevaluedAmount];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ValueChangeFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevaluationReserveOpening];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevaluationReserveFinYTD];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ForecastReplValue];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [MaintenanceExpenditure];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT (getdate()) FOR [DateCreated];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [ImpairmentTransfer];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DirtyFlag];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevaluationReserveFinYTDImp];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [RevaluationReserveFinYTDDepr];
ALTER TABLE [dbo].[AssetRegisterIconFin2014] ADD  DEFAULT ((0)) FOR [DisposalProfitLoss];
