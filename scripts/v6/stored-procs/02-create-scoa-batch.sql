...
BEGIN
	...
	-- The integration method determines at what point we commit to the register. For NONE, we commit immediately and so have to roll up already 
	-- comitted journals
	DECLARE @COMITTED INT = 3;
	DECLARE @PENDING_AUTHORISATION INT = 4;
