CREATE PROCEDURE [dbo].[InterimDepreciationDBalMonth_SCOA](
	@FinYear INT,
	@Period INT,
...
BEGIN
	...
	SET @FormReference = ('DB' + CONVERT(VARCHAR(40),(DATEDIFF(DAY, '1899-12-30T00:00:00', GETDATE())) + CONVERT(INT,86400 * CONVERT(FLOAT,GETDATE() - CONVERT(DATETIME,GETDATE())))))
	...
	SET @SQL = '
		...
		,DateLastFinMonth = @IntDeprDate
		,Amount = a.DepreciationFinYTD + ((DailyDepr) - (DailyDepr)*POWER(1-(10.0/100/DATEDIFF(DAY, @StartDate, @EndDate)), DeprDays))
