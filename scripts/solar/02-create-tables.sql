...
CREATE TABLE [dbo].[SCOA_PROJECT](
	[ENTITY_PROJECT_CODE] [VARCHAR](10) NOT NULL,
	[ENTITY_PROJECT] [VARCHAR](50) NOT NULL,
	[IDP_PROJECT_CODE] [VARCHAR](20) NOT NULL,
	[IDP_PROJECT] [VARCHAR](75) NOT NULL,
	[FINANCIAL_YEAR] [VARCHAR](4) NOT NULL,
	[SCOA_SEGMENT_DESCRIPTION] [VARCHAR] (360) NULL,
	[SCOA_PROJECT_GUID] [VARCHAR] (40) NULL,
	[SCOA_LEVEL_DESCRIPTION] [VARCHAR](120) NULL,
	[SCOA_PROJECT_GUID_SEQUENCE] [VARCHAR](45) NULL,
 CONSTRAINT [PK_SCOA_PROJECT] PRIMARY KEY CLUSTERED
(
	[ENTITY_PROJECT_CODE] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY];
...
CREATE TABLE LedgerJournal (
	[UNIQUE_IDENTIFIER] [bigint] NOT NULL,
	[FINANCIAL_PERIOD] [varchar](6) NOT NULL,
	[LEDGER_TRANSACTION_TYPE] [varchar](2) NOT NULL,
	[VENDOR_CODE] [varchar](2) NOT NULL,
	[JOURNAL_REFERENCE] [varchar](14) NULL,
	[JOURNAL_DESCRIPTION_1] [varchar](60) NULL,
	[JOURNAL_DESCRIPTION_2] [varchar](60) NULL,
	...
	[JOB_CATEGORY_CODE] [varchar](4) NULL,
	[QUANTITY] [numeric](25, 2) NULL,
	[DEBIT_AMOUNT] [numeric](25, 2) NOT NULL,
	[CREDIT_AMOUNT] [numeric](25, 2) NOT NULL,
	[REPLACE_WITH_DEFAULT] [bit] NOT NULL DEFAULT ((0)),
 CONSTRAINT [PK_LedgerJournal] PRIMARY KEY CLUSTERED 
(
	[UNIQUE_IDENTIFIER] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY];

--ALTER TABLE [dbo].[LedgerJournal]  WITH CHECK ADD  CONSTRAINT [CK_LedgerJournal_CreditAmount] CHECK  (([CREDIT_AMOUNT]>(0) OR [CREDIT_AMOUNT]>(0)))
...
CREATE TABLE Item (
			SEGMENT_ISN BIGINT, 
			FINANCIAL_YEAR INT, 
			SCOA_ITEM_TYPE VARCHAR(1),
			SCOA_ITEM_CODE VARCHAR(40), 
			SCOA_ITEM_GUID VARCHAR(40), 
			SCOA_SEGMENT_DESCRIPTION VARCHAR(255),
			SCOA_LEVEL_DESCRIPTION VARCHAR(120),
			SCOA_POSTING_LEVEL VARCHAR(1),
			ENTITY_SUB_ITEM_CODE VARCHAR(10),
			ENTITY_SUB_ITEM VARCHAR(50),
			SCOA_POSTING_DESCRIPTION VARCHAR(75)
);
